...
\begin{tikzpicture}
    ...
    \node[above right = 1em and 4em of in0, neuron, fill=orange!30] (enc0) {};
    \foreach\i in {1,...,4} {
        \tikzmath{int \ii; \ii = \i - 1;}
    ...
    \node[right = 4em of encc0, neuron, fill=yellow!50] (decc0) {};
    \foreach\i in {1,...,2} {
        \tikzmath{int \ii; \ii = \i - 1;}
    ...
    \node[right = 4*3em+2*2em of enc0, neuron, fill=yellow!50] (dec0) {};
    \foreach\i in {1,...,4} {
        \tikzmath{int \ii; \ii = \i - 1;}
    ...
    \node[below right = 1em and 4em of dec0, neuron, fill=cyan!30] (out0) {};
    \foreach\i in {1,...,2} {
        \tikzmath{int \ii; \ii = \i - 1;}
    ...
    \node[above = 1em of in0, helv, text=black!35!green, align=center] () {\Large Raw \tikznewl{\Large Input} \tikznewl{\Large Features}};
    \node[right = 1em of enc0, helv, text=black!30!orange, align=center] () {\Large Encoding};
    \node[left = 1em of dec0, helv, text=black!30!yellow, align=center] () {\Large Decoding};
    \node[above = 1.5em of out0, helv, text=black!30!cyan, align=center] () {\Large Classification};

    \draw[line, black!50!red] ([yshift=1.5em]enc0.west) -- ++(0,1.5em) -| node[helv, above,align=center, pos=0.25]{\Large Feature Extraction} ([yshift=1.5em]dec0.east);
    ...
    \node[right = 2em of hboxvec_last, helv, text=black!10!violet, align=center] () {\Large Latent \tikznewl{\Large Representation}};
