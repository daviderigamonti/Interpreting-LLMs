...
\todo[gray]{V: Add more subsections to this section, "Word Embeddings" is a widow subsection}

\todo[gray]{V: Spend some more words on NLP (evolution, data-driven approaches,...)}

\todo[gray]{V: Move RNNs to Deep Learning}

\todo[gray]{V: Add Markov Chains}
...
\begin{figure}[t!]
    ...
    \subfloat[Recurrent Neural Networks Architecture.\label{fig:background_rnn}]{
        \includegraphics[width=\textwidth]{background_rnn.pdf}
    }
    \quad
...
\begin{figure}[t!]
    \centering
    \includegraphics[width=0.6\textwidth]{background_ffnn-glu.pdf}
