...
The \textbf{pre-normalization (pre-norm)} \todo[orange]{cite https://arxiv.org/pdf/1809.10853, (https://aclanthology.org/P18-1167.pdf mentions tensor2tensor), https://github.com/tensorflow/tensor2tensor?tab=readme-ov-file: no single paper that claims to have introduced pre-norm} approach consists in applying layer normalization directly inside the residual block, right before the attention or feed-forward blocks.
