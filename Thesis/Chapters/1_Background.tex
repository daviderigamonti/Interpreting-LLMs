...
There exist different attention function implementations such as \emph{simple dot product}, \emph{Luong (multiplicative)} \cite{luong2015} and \emph{Bahdanau (additive)} \cite{bahdanau2015}.
