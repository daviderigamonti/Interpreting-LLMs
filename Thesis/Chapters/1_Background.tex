...
Transformer blocks \todo{compose} large part of the transformer architecure and contain \textbf{attention blocks}, \textbf{feedforward blocks}, \textbf{residual connections} and \textbf{normalization blocks}.
...
\todo[green]{feedforward}

\todo[green]{normalization and residual connections}
